...
INSERT INTO `birds_bird` VALUES (9, 'img/birds/PEACOCK.jpg', '孔雀', '鸡形目', '雉科', '孔雀属', '孔雀是一种体型较大的鸟类，雄性孔雀（孔雀）体长可达约180-210厘米，雌性孔雀（珠鸡）体长则相对较小', '雄性孔雀以其华丽的羽毛而著名，特别是其尾羽，可以展开成巨大的扇形，上面带有眼状的图案。雌性的羽毛通常是棕色或灰色，带有杂色条纹', '孔雀自然栖息在草原和森林边缘，它们喜欢开阔的林地和灌木丛', '孔雀的地理分布范围原产于南亚和东南亚，尤其是印度次大陆，但由于人工饲养，它们在世界其他地区也有分布', '无危', 1, 0, '2024-05-05');
...
-- ----------------------------
INSERT INTO `observations_observation` VALUES (14, '2025-01-20 09:01:18.370311', '动物园', '孔雀开屏', '无', 'img/upload_observation/a799eafd-d701-11ef-a0bf-44e517fec936.jpg', '孔雀', 9);
...
-- ----------------------------
INSERT INTO `user_userinfo_love` VALUES (11, 18, 14);
...
-- ----------------------------
INSERT INTO `user_userinfo_observation` VALUES (14, 18, 14);
